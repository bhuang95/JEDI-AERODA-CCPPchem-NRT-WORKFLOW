...
#       for imem in {${ENSBEG}..${ENSEND}}; do
#	      memstr=`printf %03d $imem`
#	      gdatadir=${ROTDIR}/${enkfopt}gdas.${gyy}${gmm}${gdd}/${ghh}/${memopt}${memstr}/RESTART/
#	      ls ${gdatadir}/*.fv_core.res.*
#	      ls ${gdatadir}/*.fv_tracer.res.*
#	      #/bin/rm -rf ${gdatadir}/*.fv_core.res.*
#	      #/bin/rm -rf ${gdatadir}/*.fv_tracer.res.*
#          done
#      fi
