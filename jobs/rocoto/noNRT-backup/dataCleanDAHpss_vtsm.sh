...
### Delite unnecessary ens files
    ...
    enkfGDAS_Mean_VTSM=\${dataDir}/enkfgdas.\${cycYMD}/\${cycH}/ensmean_VTSM
    enkfBakup_Mean_VTSM=\${bakupDir}/enkfgdas.\${cycYMD}/\${cycH}/ensmean_VTSM

    mkdir -p \${enkfBakup_Mean_VTSM}
    /bin/cp \${enkfGDAS_Mean_VTSM}/obs/* \${enkfBakup_Mean_VTSM}/
    /bin/cp \${enkfGDAS_Mean_VTSM}/RESTART/*.fv_aod_* \${enkfBakup_Mean_VTSM}/
    #/bin/cp \${enkfGDAS_Mean_VTSM}/RESTART/*.fv_core.* \${enkfBakup_Mean_VTSM}/
    /bin/cp \${enkfGDAS_Mean_VTSM}/RESTART/\${cyc1prefix}.fv_tracer.* \${enkfBakup_Mean_VTSM}/
    /bin/cp \${enkfGDAS_Mean_VTSM}/RESTART/\${cyc1prefix}.fv_core.* \${enkfBakup_Mean_VTSM}/
