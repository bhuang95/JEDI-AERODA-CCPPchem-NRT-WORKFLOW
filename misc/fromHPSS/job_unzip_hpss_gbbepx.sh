...
datadir=/scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/MISC/nrtGBBEPx/GBBEPx
tiledir=${datadir}/tileData
#cycS=2016051012
#cycE=2016051418
cycS=2023051600
cycE=2023061000
...
while [ ${cycN} -le ${cycE} ]; do
    ...
    hpssdir=/BMC/fdr/Permanent/${cycY}/${cycM}/${cycD}/data/grids/nesdis/GBBEPx/C96/
...
#    cp *.FV3.C96Grid.tile?.bin  ${tiledir}
