...
s1=`ls -1 ${OBSDIR_NESDIS}/*_s${STARTYMDH}*_*.nc | sort -u`
e1=`ls -1 ${OBSDIR_NESDIS}/*_e${ENDYMDH}*_*.nc | sort -u`

sleep 120

s2=`ls -1 ${OBSDIR_NESDIS}/*_s${STARTYMDH}*_*.nc | sort -u`
e2=`ls -1 ${OBSDIR_NESDIS}/*_e${ENDYMDH}*_*.nc | sort -u`
