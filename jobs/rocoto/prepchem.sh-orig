...
for n in $(seq 1 6); do
    ...
    if [ $EMITYPE -eq 2 ]; then
      ...
      # -orig NCGB=/scratch1/BMC/gsd-fv3-dev/Haiqin.Li/Develop/emi_${CASE}/GBBEPx
      NCGB=${GBBDIR:-"/scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/dataSets/GBBEPx/C96_Li_Copy20200407_NC/"}
