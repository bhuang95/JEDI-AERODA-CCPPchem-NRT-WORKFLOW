...
for ifield in ${allfields}; do
    ...
    if [ ${ifield} = "emembckg" -o ${ifield} = "ememanal" ]; then
	   ...
	   export AODTYPE="VIIRS"
	   export COMIN_OBS="/scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/dataSets/VIIRS_AOD_Obs/2016Case/thinned_debiased_C192/"
           $JEDIUSH/run_hofx_nomodel_AOD_LUTs.sh
	   err1=$?
	   export AODTYPE="MODIS"
	   export COMIN_OBS="/scratch1/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/dataSets/NNR_AOD_Obs/2016Case/thinned_debiased_C192/"
           $JEDIUSH/run_hofx_nomodel_AOD_LUTs.sh
	   err11=$?
	   ...
	   if [ $err1 -ne 0 -o $err2 -ne 0 -o $err11 -ne 0 -o $err22 -ne 0 ]; then
