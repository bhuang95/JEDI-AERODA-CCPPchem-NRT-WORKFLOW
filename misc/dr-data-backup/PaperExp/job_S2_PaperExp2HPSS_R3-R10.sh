#!/bin/bash --login
#SBATCH -J paper2hpss_R3-R10
#SBATCH -A chem-var
#SBATCH -n 1
#SBATCH -t 23:59:00
#SBATCH -p service
#SBATCH -D ./
#SBATCH -o /scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/miscLog/paper2hpss_R3-R10.txt
#SBATCH -e /scratch2/BMC/gsd-fv3-dev/MAPP_2018/bhuang/JEDI-2020/JEDI-FV3/miscLog/psper2hpss_R3-R10.txt
...
EXPNAMES="
VIIRSAOD_JEDI_ENVAR_GETKF_noRecenter_C96_C96_M20_CCPP2_yesEmisSPPT_yesPert_yesAmp_test1_201606
VIIRSAOD_JEDI_ENVAR_GETKF_yesRecenter_C96_C96_M20_CCPP2_yesEmisSPPT_yesPert_yesAmp_test1_201606
VIIRSAOD_JEDI_ENVAR_LETKF_noRecenter_C96_C96_M20_CCPP2_yesEmisSPPT_yesPert_yesAmp_test1_201606
VIIRSAOD_JEDI_ENVAR_LETKF_yesRecenter_C96_C96_M20_CCPP2_noEmisSPPT_noPert_noAmp_test1_201606
VIIRSAOD_JEDI_ENVAR_LETKF_yesRecenter_C96_C96_M20_CCPP2_yesEmisSPPT_noPert_yesAmp_test1_201606
VIIRSAOD_JEDI_ENVAR_LETKF_yesRecenter_C96_C96_M20_CCPP2_yesEmisSPPT_yesPert_noAmp_test1_201606
...
while [ ${CDATE} -le ${EDATE} ]; do
	...
	echo ${HERAFILEDIR}
        cd ${HERAFILEDIR}
        #htar -P -cvf ${HPSSFILE} *
	tar -cvf ${TMPDIR}/${HPSSFILE} *
	ERR=$?
	if [ ${ERR} -ne 0 ]; then
	    echo ${CDATE}  >> ${FAILEDREC}
	    exit 100
        fi
        hsi "put ${TMPDIR}/${HPSSFILE} : ${HPSSFILEDIR}/${HPSSFILE}"
	ERR=$?
	echo ${ERR}
	if [ ${ERR} -ne 0 ]; then
	    echo ${CDATE}  >> ${FAILEDREC}
